...
export class Usuarios {
  ...
  getUsuarios(page: number, limit: number, nombre: string = ''): Observable<any> {
    let params = new HttpParams().set('page', page.toString()).set('per_page', limit.toString());
    if (nombre.trim() !== '') {
      params = params.set('email', nombre);
    }
